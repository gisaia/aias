...
export APROC_ZARR_INPUT_STORAGE_TYPE=""
export APROC_ZARR_INPUT_STORAGE_BUCKET=""
export APROC_ZARR_INPUT_STORAGE_API_KEY_PROJECT=""
export APROC_ZARR_INPUT_STORAGE_API_KEY_PRIVATE_KEY_ID=""
export APROC_ZARR_INPUT_STORAGE_API_KEY_PRIVATE_KEY=""
