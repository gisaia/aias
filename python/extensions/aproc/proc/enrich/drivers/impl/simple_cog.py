...
class Driver(EnrichDriver):
    ...
    def supports(self, resource: Item, extra_params: dict[str, Any] = {}) -> bool:
        return extra_params.get("asset_type", "") == "cog" and resource.properties is not None and resource.properties.item_format is not None and resource.properties.item_format.lower() in self.supported_formats()
