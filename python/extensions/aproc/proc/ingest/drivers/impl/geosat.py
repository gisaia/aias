...
from extensions.aproc.proc.ingest.drivers.impl.utils import (
    downsample_image, find_or_none, raster_to_jpg, get_epsg_from_gdal_info_gcps,
...
class Driver(IngestDriver):
    ...
    def transform_assets(self, url: str, assets: list[Asset]) -> list[Asset]:
        if self.quicklook_path is None and IngestDriver.must_build_preview(Driver.configuration, self.data_path, local_remote_both="both"):
            ...
            raster_to_jpg(self.data_path, Driver.OVERVIEW_FROM_TIFF_PCT, Driver.OVERVIEW_FROM_TIFF_PCT, output_path=quicklook.href, bands_list=[1, 2, 3], stretch=Driver.configuration.get('overview_stretch', False))
