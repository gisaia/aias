...
class Driver(IngestDriver):
    ...
    def transform_assets(self, url: str, assets: list[Asset]) -> list[Asset]:
        if self.quicklook_path is None and self.image_path and ((AccessManager.is_local(self.image_path) and Driver.configuration.get('build_overview_when_local', True)) or (not AccessManager.is_local(self.image_path) and Driver.configuration.get('build_overview_when_remote', False))):
