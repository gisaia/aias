# A dictionary with name/version for key/value describing one or more softwares that produced the data. Schema

```txt
aeopres_model#/$defs/Properties/properties/processing:software
```
