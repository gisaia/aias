...
class Asset(BaseModel, extra=Extra.allow):
    ...
    asset_type                    :ResourceType     | None = Field(default=None, title="Type of data")
    asset_format                  :AssetFormat      | None = Field(default=None, title="Data format")
...
class Properties(BaseModel, extra=Extra.allow):
    ...
    item_type                     :ResourceType         | None = Field(default=None, title="Type of data")
    item_format                   :ItemFormat       | None = Field(default=None, title="Data format")
