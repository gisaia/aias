...
class Asset(BaseModel):
    ...
    href                          :str                     = Field(default=None, title="Absolute link to the asset object.", max_length=300)
    relative_href                 :str              | None = Field(default=None, title="Relative link to the asset object.", max_length=300)
    object_store                  :str              | None =Field(default=None, title="Object store link to the asset object.")
