...
class Asset(BaseModel, extra=Extra.allow):
    ...
    aeo__managed                  :bool             | None = Field(default=True, title="Whether the asset is managed by AEOPRS or not.")
    aeo__object_store_bucket      :str              | None = Field(default=None, title="Object store bucket for the asset object.")
    aeo__object_store_key         :str              | None = Field(default=None, title="Object store key of the asset object.")
